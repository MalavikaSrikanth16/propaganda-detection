...
class FrameNetManager:
    ...
    def score_modified(self, stems, poses, suffix=''):
        ...
        for i in range(len(stems)):
                ...
                if self.binary:
                    ...
                    if full_pos in self.framenetScores and stem in self.framenetScores[full_pos]:
                        causal_fn_score += self.framenetScores[full_pos][stem]
                        
                pos += '_anticausal'
                if pos in self.framenetScores and stem in self.framenetScores[pos]:
                    anticausal_fn_score += self.framenetScores[pos][stem]

        return causal_fn_score, anticausal_fn_score
